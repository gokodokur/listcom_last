...
import 'package:listcom/bloc/language/language_state.dart';
import 'package:listcom/extension/context_extension.dart';
import 'package:listcom/helper/language_helper.dart';
...
class LanguageSelectBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Widget buildLanguageItem(Locale locale, bool isSelected) { // Dil seçim widget'ı
